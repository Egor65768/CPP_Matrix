...
### Для сборки исполняемого файла тестов, а так же сборки статической библиотеки:
...
### Для удаления старых файлов и создания новой версии библиотеки:
